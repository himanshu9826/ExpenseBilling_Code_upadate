...
namespace CINC.DAL.AbstractRepository
{
    public abstract class AbstractRepository<TEntity> : IAbstractRepository<TEntity> where TEntity : class
    {
        ...
        public virtual IEnumerable<TEntity> GetAll(params System.Linq.Expressions.Expression<Func<TEntity, object>>[] navigationProperties)
        {
        ...
        public virtual IEnumerable<TEntity> GetList(Func<TEntity, bool> where, params System.Linq.Expressions.Expression<Func<TEntity, object>>[] navigationProperties)
        {
            IQueryable<TEntity> dbQuery = Context.Set<TEntity>();
